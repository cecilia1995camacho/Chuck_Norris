// /// Event Bubbling
// const childNode = doucment.querySelector("li");
// const parentNode = document.querySelector("ul");
// const grandPerentNode = document.querySelector(".card-action");
...
//     console.log("Grand Prent Node: card-action");

// });

// grandGrandParentNode.addEventListener("click", function(){
//     console.log("Grand Grand Prent Node: card-action");
...
//         console.llog(e.target.parentElement.className);
//         console.llog(e.target.parentElement.classList);
