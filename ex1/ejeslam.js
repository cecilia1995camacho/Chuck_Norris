...
arr = [
   ...
   arr.forEach(function(element, i) {
    console.log(" Das Tag der Woche Nummer " + (i + 1) + " ist "  + element);
   });
   ...
   users.forEach(userinfo);//console.log(users[0].firstName);function userinfo(element, index) {
   
    if (element.address.country == 'MX') {
   console.log(`${element.firstName} ${element.address.country} ${element.phones[2]}`);
